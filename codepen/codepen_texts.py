...
text = rptObj.ui.texts.text("**Test** text %s " % rptObj.symbols.maths.SQUARE_ROOT).css({"color": 'red'})
...
#
rptObj.ui.vignets.text({'title': 'Python', 'number': 10000, 'text': 'This is the **content**', 'color': 'green', 'url':
...
button.click([rptObj.js.window.alert("ok"), text.build("Youpi")])
